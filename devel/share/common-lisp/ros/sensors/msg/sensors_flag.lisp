...
(cl:defmethod cl:initialize-instance :after ((m <sensors_flag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensors_flag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensors-msg:<sensors_flag> is deprecated: use sensors-msg:sensors_flag instead.")))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <sensors_flag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensors-msg:flag-val is deprecated.  Use sensors-msg:flag instead.")
  (flag m))
